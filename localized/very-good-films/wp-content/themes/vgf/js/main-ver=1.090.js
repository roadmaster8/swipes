...
var Device = {
  ...
  refresh: function refresh() {
    ...
    if (document.getElementsByClassName('c-films__th--desktop').length !== 0) {
      if (document.getElementsByClassName('c-films__th--desktop')[0].offsetParent === null) {
        Device.mobile = true;
      } else {
        Device.mobile = false;
      }
...
var Scroll = {
  ...
  doScroll: function doScroll() {
    ...
    if (Scroll.lastScrollPos !== _newPos) {
      ...
      if (Scroll.adjustScrollPos > Scroll.scrollerStart && Scroll.adjustScrollPos < Scroll.scrollerEnd) {
        Scroll.adjustScrollPos = Scroll.scrollerStart;
      } else if (Scroll.adjustScrollPos >= Scroll.scrollerEnd) {
        Scroll.adjustScrollPos = Scroll.scrollPos - (Scroll.scrollerEnd - Scroll.scrollerStart);
      }
    }
  },
  getLoadOffset: function getLoadOffset() {
    ...
    var _loadEls = document.getElementsByClassName('c-page state-active')[0].getElementsByClassName('js-scroll-load');
  ...
  doLoad: function doLoad() {
    if (Scroll.loadObs) {
      for (var _i = 0; _i < Scroll.loadObs.length; _i++) {
        if (Scroll.loadObs[_i]['offset'] < Scroll.adjustScrollPos && Scroll.loadObs[_i]['loaded'] === false && Boot.pageLoaded === true) {
...
var Accordion = {
  count: 0,
  init: function init() {
    var _page = document.getElementsByClassName('c-page state-active')[0];
...
var Video = {
  ...
  init: function init() {
    ...
    document.body.innerHTML += '<div class="c-video"><a href="#" class="c-video__close-overlay js-video-close"></a><a href="#" class="c-video__close js-video-close"><div class="c-video__close__line c-video__close__line--top"></div><div class="c-video__close__line c-video__close__line--bottom"></div></a><div class="c-video__inner"><a href="#" class="c-video__close-overlay js-video-close"></a><div class="c-video__wrapper js-object-size" data-width="1600" data-height="900"></div></div></div>';
    ...
    if (_els.length > 0) {
      for (var _i2 = 0; _i2 < _els.length; _i2++) {
        _els[_i2].addEventListener('click', function (_evt) {
          ...
          document.getElementsByClassName('c-video__wrapper')[0].innerHTML = '<div class="plyr__video-embed" id="player"><iframe src="https://www.youtube.com/embed/' + _videoID + '?origin=' + window.location.origin + '&amp;iv_load_policy=3&amp;modestbranding=1&amp;playsinline=1&amp;showinfo=0&amp;rel=0&amp;enablejsapi=1" allowfullscreen allowtransparency allow="autoplay"></iframe>';
          document.getElementsByClassName('c-video')[0].classList.add('state-video-active');
    ...
    if (_els.length > 0) {
      for (var _i3 = 0; _i3 < _els.length; _i3++) {
        _els[_i3].addEventListener('click', function (_evt) {
          ...
          document.getElementsByClassName('c-video')[0].classList.remove('state-video-active');
...
var Sort = {
  ...
  mobile: null,
  init: function init() {
    var _trs = document.getElementsByClassName('c-films__tr');
    ...
    if (_trs) {
      ...
      for (var _i = 0; _i < _trs.length; _i++) {
        ...
        Sort.films[_i].director = _trs[_i].getAttribute('data-director');
        Sort.films[_i].country = _trs[_i].getAttribute('data-country');
        Sort.films[_i].genre = _trs[_i].getAttribute('data-genre');
      }

      Sort.wrapper = document.getElementById('film-list');
      Sort.bindClick();
      Sort.doResize();
    } else {
      Sort.films = null;
  ...
  bindClick: function bindClick() {
    ...
    if (_els) {
      ...
      document.addEventListener('input', function (_event) {
        ...
        document.getElementById('select-text').innerHTML = _event.target.options[_event.target.selectedIndex].innerHTML;
    ...
    if (Sort.films !== null) {
      if (Sort.Mobile !== Device.mobile) {
        ...
        if (_swapEls.length > 0) {
          ...
          document.getElementById('select-text').innerHTML = 'Sort via: Title';
          Sort.sortASC('title');
          Sort.reorderFilms();
        }
      }
...
var Layout = {
  doResize: function doResize() {
    var _imgs = document.getElementsByClassName('c-film__image');
    ...
    var _text = document.getElementsByClassName('c-film__text');
    ...
    var _headings = document.getElementsByClassName('c-film__text__heading');
    ...
    var _content = document.getElementsByClassName('c-film__text__content');
    ...
    var _titles = document.getElementsByClassName('c-film__image');
    ...
    var _tds = document.getElementsByClassName('c-films__td');
    ...
    if (_tds.length > 0) {
      ...
      if (Device.mobile === false) {
        var _tdTitleWidth = 0;
        _tds = document.getElementsByClassName('c-films__td--title');
        ...
        var _tdYearWidth = 0;
        _tds = document.getElementsByClassName('c-films__td--year');
        ...
        var _tdDirectorWidth = 0;
        _tds = document.getElementsByClassName('c-films__td--director');

        for (var _i11 = 0; _i11 < _tds.length; _i11++) {
          if (_tdDirectorWidth < _tds[_i11].clientWidth) {
            _tdDirectorWidth = Math.ceil(_tds[_i11].clientWidth);
          }
        }

        var _tdCountryWidth = 0;
        _tds = document.getElementsByClassName('c-films__td--country');
        ...
        var _tdGenreWidth = 0;
        _tds = document.getElementsByClassName('c-films__td--genre');
        ...
        var _totalWidth = _tdTitleWidth + _tdYearWidth + _tdDirectorWidth + _tdCountryWidth + _tdGenreWidth;

        var _availableWidth = Math.floor(document.getElementsByClassName('c-films__details__inner')[0].clientWidth);
        ...
        for (var _i16 = 0; _i16 < _tds.length; _i16++) {
          _tds[_i16].style.width = _tdDirectorWidth + _addWidth + 'px';
        }
        ...
        for (var _i20 = 0; _i20 < _text.length; _i20++) {
          _text[_i20].style.width = _tdYearWidth + _addWidth + _tdDirectorWidth + _addWidth + _tdCountryWidth + _addWidth + _tdGenreWidth + _addWidth + 'px';
        }
        ...
        if (Device.screenWidth > 1380) {
          ...
          for (var _i22 = 0; _i22 < _content.length; _i22++) {
            _content[_i22].style.width = _tdDirectorWidth + _addWidth + _tdCountryWidth + _addWidth + _tdGenreWidth + 'px';
          }
        }
      }
    }
...
var SubscribeForm = {
  ...
  init: function init() {
    if (document.getElementsByClassName('js-toggle-form').length > 0) {
      ...
      document.getElementsByClassName('js-toggle-form')[0].addEventListener('click', function (_evt) {
        _evt.preventDefault();
  ...
  bindSubmit: function bindSubmit() {
    Helper.on('.c-site-wrapper', 'submit', '#mc-embedded-subscribe-form', function (_evt) {
      _evt.preventDefault();

      SubscribeForm.doChange();

      if (document.getElementById('mc-embedded-subscribe-form').classList.contains('state-valid')) {
  ...
  doChange: function doChange() {
    ...
    if (/(^\w.*@\w+\.\w)/.test(_email)) {
      document.getElementById('mc-embedded-subscribe-form').classList.add('state-valid');
    } else {
      document.getElementById('mc-embedded-subscribe-form').classList.remove('state-valid');
    }
  },
